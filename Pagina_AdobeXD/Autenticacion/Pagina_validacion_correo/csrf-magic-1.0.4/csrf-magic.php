 ...
 * most websites.
 */
$GLOBALS['csrf']['expires'] = 1200; //15 minutos, ya que son segundos //Aqui son los segundos
...
function csrf_callback($tokens) {
    ...
    echo "<html><head><title>CSRF check failed</title></head>
        <body>
        <p>Su sesion tal vez ha experido! , no tienes cookies activadas, por favor inicie sesion nuevamente para activar las cookies
        </p>
        <form method='post' action=''>$data<input type='submit' value='Volver a intentar' /></form>
